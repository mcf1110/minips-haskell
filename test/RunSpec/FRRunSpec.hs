...
frTests =
  ...
  , testGroup
      ...
      , testCase "Adds negative float" $
        assertEqual
          ""
          (2 * (-pi))
          (floatAt 2 $ runSeg [0xc0490fdb] [0x3c011001, 0xc4200000, 0x46000080])
      , testCase "Adds negative double" $
        assertEqual
          ""
          (2 * (-pi))
          (doubleAt 2 $
           runSeg [0x54442d18, 0xc00921fb] [0x3c011001, 0xd4200000, 0x46200080])
      ]
  , testGroup
      "FP Sub"
      [ testGroup
